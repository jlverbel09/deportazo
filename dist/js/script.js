    ...
    $.ajax({
        ...
        success: async function (respuesta) {
            ...
            setTimeout(async () => {
                ...
                await cargarTablaEnfrentamientosRapidos()
            }, 1000);
...
function cargarTablaEnfrentamientosRapidos() {
    $.ajax({
        type: "GET",
        url: './services/voleybol_actions.php?accion=cargarTablaEnfrentamientosRapidos&cantidad_equipos=' + $('#cant_equipos').val(),
        data: {},
        dataType: "json",
        success: function (respuesta) {

            setTimeout(() => {
                $('#tablaEnfrentamientosRapidos').html(respuesta.tabla)
            }, 1000);
        }
    });
}

function cambiarEstado(id, equipo) {

    $.ajax({
        type: "GET",
        url: './services/voleybol_actions.php?accion=cambiarEstado&id=' + id+'&equipo='+equipo,
        data: {},
        dataType: "json",
        success: function (respuesta) {
