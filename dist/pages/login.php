                ...
                <div class="container-fluid p-0">
                    ...
                    <div class="row justify-content-center d-flex align-items-center fondo">
                        ...
                        <div class="col-md-3 offset-md-0">
                            <form class="row formulario pt-5 pb-5 px-1"><input type="hidden" name="_token"
                                    autocomplete="on" value="I2wMMb24L7w0vrR0yjmryqLnn9nZkkyHQCXVkpVn">
    ...
    padding: 5px;" src="../../dist/assets/img/grupos/corazonlatino.png" alt="">
                                ...
                                <!-- <div class="col-md-5 pt-2">
                                    <div class="form-check"><input class="form-check-input" type="checkbox"
                                            ...
                                            for="remember"> Recordarme </label></div>
                                </div> -->
                                <!--  <div class="col-md-7 text-center"><a class="btn btn-link text-info" href="">Registrar
                                        Usuario</a></div> -->
                        ...
                        <div class="text-center logologin">
                            <a href="../../index">
                                <img width="50%" class=" bordered" src="../../dist/assets/img/logo.png" alt="">
                            </a>
                        </div>
