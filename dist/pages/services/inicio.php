...
where  
	...
	")->fetch();
        ...
        $colorcaja = $dataGrupo[$grupo]['colores']['primario'] ?? '#000';
        $colorTextocaja = $dataGrupo[$grupo]['colores']['secundario'] ?? '#000';
        $contenido = '
...
<div class="row p-0 m-0">
    <div class="col-12 pb-5">
        <div class="row">
            <div class="col-6 col-sm-6 col-md-3 pointer " onclick="redireccion(`lista_torneos`)" >
                <div class="info-box"> <span class="info-box-icon text-bg-info shadow-sm" style="background-color: ' . $colorcaja . ' !important;color: ' . $colorTextocaja . ' !important"> <i class="bi bi-bar-chart-line"></i> </span>
            ...
            <!--<div class="col-6 col-sm-6 col-md-3 pointer">
                <div class="info-box"> <span class="info-box-icon text-bg-info shadow-sm" style="background-color: ' . $colorcaja . ' !important;color: ' . $colorTextocaja . ' !important"> <i class="bi bi-hand-thumbs-up-fill"></i> </span>
            ...
            <div class="col-6 col-sm-6 col-md-3 pointer" onclick="redireccion(`galeria`)">
                <div class="info-box"> <span class="info-box-icon text-bg-info shadow-sm" style="background-color: ' . $colorcaja . ' !important;color: ' . $colorTextocaja . ' !important"> <i class="bi bi-card-image"></i> </span>
            ...
            <div class="col-6 offset-md-0 col-sm-6 col-md-3 pointer" ' . $accionUsuario . '>
                <div class="info-box"> <span class="info-box-icon text-bg-info shadow-sm" style="background-color: ' . $colorcaja . ' !important;color: ' . $colorTextocaja . ' !important"> <i class="bi bi-people-fill"></i> </span>
            ...
            <div class="col-6  offset-md-0 col-sm-6 col-md-3 pointer" onclick="redireccion(`triunfos`)">
                <div class="info-box"> <span class="info-box-icon text-bg-info shadow-sm" style="background-color: ' . $colorcaja . ' !important;color: ' . $colorTextocaja . ' !important"> <i class="bi bi-award"></i> </span>
    ...
    <div class="col-lg-4 col-sm-10">
        <img width="100%" src="../../dist/assets/img/imagenes/' . $dataGrupo[$grupo]['iconoInicial']. '" alt="">
    </div>
</div>';
        $data = [
            'titulo' => 'Inicio',
