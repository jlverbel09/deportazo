...
<body class="sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed text-sm" style="height: auto;">
    <div id="app" class="wrapper" data-v-app="">
        <div class="preloader flex-column justify-content-center align-items-center bg-principal" style="height: 0px;">
            <img class="animation__wobble" src="./dist/assets/img/portadas/7.jpg" alt="logo" height="60" width="60"
                style="display: none;">
        </div>
        <main class="">
            <div class="loginbackground d-flex justify-content-between align-items-center">
                <div class="container-fluid p-0">
                    <div id="carouselExampleSlidesOnly" class="carousel slide carousel-fade height-100"
                        ...
                        <div class="carousel-inner height-100">
                            <div class="carousel-item w-100 h-100" data-bs-interval="3000"
                                style="background-image: url(./dist/assets/img/portadas/11.jpg?1); background-size: cover;">
                            </div>
                            <div class="carousel-item w-100 h-100 active carousel-item-start" data-bs-interval="3000"
                                style="background-image: url(./dist/assets/img/portadas/22.jpg?1); background-size: cover;">
                            </div>
                            <div class="carousel-item w-100 h-100 carousel-item-next carousel-item-start"
                                data-bs-interval="3000"
                                style="background-image: url(./dist/assets/img/portadas/33.jpg?1); background-size: cover;">
                            </div>
                            <div class="carousel-item w-100 h-100" data-bs-interval="3000"
                                style="background-image: url(./dist/assets/img/portadas/44.jpg?1); background-size: cover;">
                            </div>
                            <div class="carousel-item w-100 h-100" data-bs-interval="3000"
                           ...
                           <!--  <div class="carousel-item w-100 h-100" data-bs-interval="3000"
                            ...
                            <div class="carousel-item w-100 h-100" data-bs-interval="3000"
                                style="background-image: url(./dist/assets/img/portadas/7.jpg); background-size: cover;">
                            </div>
                            <div class="carousel-item w-100 h-100" data-bs-interval="3000"
                                style="background-image: url(./dist/assets/img/portadas/5.jpg); background-size: cover;">
                            </div>
                            <div class="carousel-item w-100 h-100" data-bs-interval="3000"
                                style="background-image: url(./dist/assets/img/portadas/8.jpg); background-size: cover;">
                            </div>
                    ...
                    <div class="row  pt-4 fondo text-center justify-content-center">
                        <div class="col-lg-12 col-md-3 ">
                            <img width="300" class="bordered  mt-2" src="./dist/assets/img/logo.png" alt="">
                        </div>

                        <div class="col-12 m-0 p-0 cont_movil row justify-content-center">
                            <div class="col-lg-5 col-md-12  px-3">
                                <h1 class="text-white col-lg-10 col-md-12   mb-5">
                                    <b>El Corazón Digital del Voleibol de Madrid</b>
                                </h1>

                                <p class="text-white col-12 " style=" text-align:justify; font-size: 18px">
                                    Deportazo es la plataforma online esencial para la comunidad de voleibol de Madrid, diseñada para centralizar y simplificar la vida deportiva de equipos, organizadores y jugadores. Con nuestra herramienta, los equipos pueden registrarse fácilmente, acceder al calendario más completo de torneos de la región e iniciar o aceptar retos amistosos con rivales de nivel compatible. <br><br> Olvídate de la gestión desorganizada: Deportazo te conecta con toda la red de voleibol madrileño, asegurando que tu equipo encuentre siempre la oportunidad perfecta para jugar, competir y crecer.
                                </p>
                            </div>
                            <div class="col-lg-3 col-md-12 px-5 p-0 m-0">
                                ...
                                <div class="d-flex flex-wrap justify-content-center">
                                    ...
                                    <!--  <div class="col-5 mx-2">
                                        ...
                                        <p class="text-white">SENTIMIENTO LATINO</p>
                                    </div>
                                    <div class="col-5 mx-2">
                                        <a href="./index">
                                            <img width="100%" style="border-radius: 10px;" src="./dist/assets/img/grupos/deporteparatodos.jpg" alt="">
                                        </a>
                                        <p class="text-white">DEPORTE PARA TODOS</p>
                                    </div>
                                    <div class="col-5 mx-2">
                                        <a href="./index">
                                            <img width="100%" style="border-radius: 10px;" src="./dist/assets/img/grupos/multicultural.jpg" alt="">
                                        </a>
                                        <p class="text-white">MULTICULTURAL VOLEY MADRID</p>
                                    </div> -->
